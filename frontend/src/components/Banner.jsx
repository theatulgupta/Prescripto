    ...
    <div className="flex px-6 my-20 rounded-lg bg-primary sm:px-10 md:px-14 lg:px-12 md:mx-10">
      ...
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
        ...
        <button
          ...
          className="px-8 py-3 mt-6 text-sm transition-all bg-white rounded-full sm:text-gray-600 hover:scale-105"
        >
          Create Account
        </button>
      </div>
      ...
      {/* Right Side */}
      <div className="hidden md:w-1/2 lg:w-[370px] md:block relative">
        <img
